...
peptide_matrix = write_matrix_peptides(data,filename = "DIA-peptide-matrix", rm.decoy = TRUE)
write.table(peptide_matrix, sep="\t", file = "DIA-peptide-matrix.tsv", row.names=FALSE)

protein_matrix = write_matrix_proteins(data,filename = "DIA-protein-matrix", rm.decoy = TRUE)
